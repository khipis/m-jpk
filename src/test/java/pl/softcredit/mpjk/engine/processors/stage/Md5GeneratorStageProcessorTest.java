...
import static pl.softcredit.mpjk.engine.TestPaths.MD5_FILE_NAME_SCHEME_VERSION_1;
import static pl.softcredit.mpjk.engine.TestPaths.INPUT_FILES_DIR_PATH_IN_TEST_RESOURCES;
import static pl.softcredit.mpjk.engine.TestPaths.MD5_FILE_NAME_SCHEME_VERSION_2;
...
public class Md5GeneratorStageProcessorTest {
    ...
    @Test
    public void shouldSaveFileWithGeneratedMd5IntoWorkingDirectoryForVersion1() throws Exception {
        ...
        assertFile(MD5_FILE_NAME_SCHEME_VERSION_1);
    }

    @Test
    public void shouldSaveFileWithGeneratedMd5IntoWorkingDirectoryForVersion2() throws Exception {
        whenConfigurationWith(XML_FILE_NAME_SCHEME_VERSION_2, JPK_VAT_SCHEME_FILE_NAME_VERSION_2);

        md5GeneratorStageProcessor.process(config);

        assertFile(MD5_FILE_NAME_SCHEME_VERSION_2);
    }
