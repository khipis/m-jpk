...
public class TestDummies {
    ...
    public static final String KEY_FILE = "valid_JPK_VAT(1)_file.key";
    public static final String VEC_FILE = "valid_JPK_VAT(1)_file.vec";
    ...
    public static final String VALID_FILE_PATH_FROM_RESOURCES = INPUT_FILES_DIR + separator + VALID_FILE;
