...
public class TestPaths {
    ...
    //File names valid for scheme version 2 Schemat_JPK_VAT(2)_v1-0.xsd
    public static final String VALID_FILE_NAME_WITHOUT_EXTENSION_VERSION_2 = "JPK_VAT_002";
    public static final String XML_FILE_NAME_SCHEME_VERSION_2 = VALID_FILE_NAME_WITHOUT_EXTENSION_VERSION_2 + XML_EXTENSION;
    public static final String ZIP_FILE_NAME_SCHEME_VERSION_2 = XML_FILE_NAME_SCHEME_VERSION_2 + ZIP_EXTENSION;
    public static final String AES_FILE_NAME_SCHEME_VERSION_2 = XML_FILE_NAME_SCHEME_VERSION_2 + ZIP_EXTENSION + AES_EXTENSION;
    public static final String MD5_FILE_NAME_SCHEME_VERSION_2 = AES_FILE_NAME_SCHEME_VERSION_2 + MD5_EXTENSION;
    public static final String KEY_FILE_NAME_SCHEME_VERSION_2 = VALID_FILE_NAME_WITHOUT_EXTENSION_VERSION_2 + KEY_EXTENSION;
    public static final String RSA_KEY_FILE_NAME_SCHEME_VERSION_2 = KEY_FILE_NAME_SCHEME_VERSION_2 + RSA_EXTENSION + BASE64_EXTENSION;
    public static final String SHA_FILE_NAME_SCHEME_VERSION_2 = VALID_FILE_NAME_WITHOUT_EXTENSION_VERSION_2 + SHA256_EXTENSION;
    public static final String VEC_FILE_NAME_SCHEME_VERSION_2 = VALID_FILE_NAME_WITHOUT_EXTENSION_VERSION_2 + VEC_EXTENSION;
    public static final String VEC_FILE_NAME_BASE64_SCHEME_VERSION_2 = VEC_FILE_NAME_SCHEME_VERSION_2 + BASE64_EXTENSION;
    public static final String VALIDATION_FILE_NAME_SCHEME_VERSION_2 = XML_FILE_NAME_SCHEME_VERSION_2 + VALIDATION_EXTENSION;
    ...
    public static final String ZIP_FILE_PATH_FROM_MF_IN_RESOURCES_VERSION_1 = XML_FILE_FROM_MF_IN_RESOURCES_VERSION_1 + ZIP_EXTENSION;
    public static final String AES_FILE_PATH_FROM_MF_IN_RESOURCES_VERSION_1 = ZIP_FILE_PATH_FROM_MF_IN_RESOURCES_VERSION_1 + AES_EXTENSION;
    ...
    public static final String JPK_VAT_SCHEME_FILE_NAME_PATH_IN_RESOURCES_VERSION_1 = SCHEMES_DIR_PATH_IN_TEST_RESOURCES + separator + JPK_VAT_SCHEME_FILE_NAME_VERSION_1;
    ...
    //File full paths valid for scheme version 2 Schemat_JPK_VAT(2)_v1-0.xsd
    public static final String XML_FILE_PATH_IN_RESOURCES_VERSION_2 = INPUT_FILES_DIR_PATH_IN_TEST_RESOURCES + separator + XML_FILE_NAME_SCHEME_VERSION_2;
    public static final String XML_FILE_FROM_MF_IN_RESOURCES_VERSION_2 = INPUT_FILES_DIR_PATH_IN_TEST_RESOURCES + separator + "JPK_VAT_002.xml";
    public static final String AES_FILE_PATH_IN_RESOURCES_VERSION_2 = INPUT_FILES_DIR_PATH_IN_TEST_RESOURCES + separator + AES_FILE_NAME_SCHEME_VERSION_2;
    public static final String ZIP_FILE_PATH_FROM_MF_IN_RESOURCES_VERSION_2 = XML_FILE_FROM_MF_IN_RESOURCES_VERSION_2 + ZIP_EXTENSION;
    public static final String AES_FILE_PATH_FROM_MF_IN_RESOURCES_VERSION_2 = ZIP_FILE_PATH_FROM_MF_IN_RESOURCES_VERSION_2 + AES_EXTENSION;
    public static final String RSA_KEY_FILE_PATH_IN_RESOURCES_VERSION_2 = RESOURCES_DIR_PATH_IN_TEST_RESOURCES + "JPKMFTest-klucz publiczny do szyfrowania.pem";
    public static final String JPK_VAT_SCHEME_FILE_NAME_PATH_IN_RESOURCES_VERSION_2 = SCHEMES_DIR_PATH_IN_TEST_RESOURCES + separator + JPK_VAT_SCHEME_FILE_NAME_VERSION_2;
    public static final String INVALID_SCHEME_PATH_IN_RESOURCES_VERSION_2 = SCHEMES_DIR_PATH_IN_TEST_RESOURCES + separator + INVALID_SCHEME_NAME;
    ...
    //Working directory in target generated files paths valid for version 2 Schemat_JPK_VAT(2)_v1-0.xsd
    public static final String AES_FILE_PATH_IN_WORKING_DIR_VERSION_2 = WORKING_DIR_PATH_IN_TARGET + separator + AES_FILE_NAME_SCHEME_VERSION_2;
    public static final String ZIP_FILE_PATH_IN_WORKING_DIR_VERSION_2 = WORKING_DIR_PATH_IN_TARGET + separator + XML_FILE_NAME_SCHEME_VERSION_2 + ZIP_EXTENSION;
    public static final String RSA_KEY_FILE_PATH_IN_WORKING_DIR_VERSION_2 = WORKING_DIR_PATH_IN_TARGET + separator + KEY_FILE_NAME_SCHEME_VERSION_2 + RSA_EXTENSION;
    public static final String XML_FILE_PATH_IN_WORKING_DIR_VERSION_2 = WORKING_DIR_PATH_IN_TARGET + separator + XML_FILE_NAME_SCHEME_VERSION_2;
