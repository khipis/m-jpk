...
import pl.softcredit.mpjk.engine.processors.stage.Md5GeneratorStageProcessor;
...
public final class JpkProcessors {
    ...
    public static final JpkProcessor MD5_GENERATOR_STAGE_PROCESSOR = new Md5GeneratorStageProcessor();
    ...
    private static final Map<String, JpkProcessor> PROCESSORS_MAP =
            ImmutableMap.<String, JpkProcessor>builder().
                    ...
                    put("MD5_GENERATOR", MD5_GENERATOR_STAGE_PROCESSOR).
                    put("AES_DECRYPT", AES_DECRYPT_STAGE_PROCESSOR).
                    put("RSA_ENCRYPT", RSA_ENCRYPT_STAGE_PROCESSOR).
                    build();

    static JpkProcessor getProcessorByString(String processorName)
            throws JpkException {
    ...
    public static JpkProcessor[] getProcessingFlow(String commaSeparatedProcessingFlow)
            throws JpkException {
