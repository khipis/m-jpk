...
public final class DefaultJpkConfiguration implements JpkConfiguration {
    ...
    public String getProcessingFlow() {
        return "CONFIG_VALIDATION,SCHEME_VALIDATION,CLEAN_WORKING_DIRECTORY,FORMAL_VALIDATION,SHA256_GENERATOR,KEY_GENERATOR,VECTOR_GENERATOR,ZIP,AES_ENCRYPT,AES_DECRYPT,RSA_ENCRYPT";
    }
